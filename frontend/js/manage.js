    ...
    body: `
      <div class="form-grid">
        <div class="field"><label>类型 <span class="req">*</span></label>
          <select id="mm-type"><option value="CHAT">CHAT(对话)</option><option value="EMBEDDING">EMBEDDING(向量)</option></select></div>
        <div class="field"><label>模型名 <span class="req">*</span></label>
          <input id="mm-name" placeholder="如:deepseek-chat / text-embedding-v3"></div>
        <div class="field" style="grid-column:1/-1"><label>服务地址(baseUrl) <span class="req">*</span></label>
          <input id="mm-url" placeholder="如:https://api.deepseek.com"></div>
        <div class="field" style="grid-column:1/-1"><label>API Key(本地无鉴权可空)</label>
          <input id="mm-key" placeholder="sk-…"></div>
      </div>
      <div class="ph-title dim small" style="margin:14px 0 6px">高级参数(可空,按服务默认)</div>
      <div class="form-grid">
        <div class="field"><label>temperature</label><input id="mm-temp" type="number" step="0.1" min="0" max="2"></div>
        <div class="field"><label>maxTokens</label><input id="mm-maxtok" type="number" min="1"></div>
        <div class="field"><label>topP</label><input id="mm-topp" type="number" step="0.1" min="0" max="1"></div>
        <div class="field"><label>frequencyPenalty</label><input id="mm-fp" type="number" step="0.1"></div>
        <div class="field"><label>presencePenalty</label><input id="mm-pp" type="number" step="0.1"></div>
        <div class="field"><label>seed</label><input id="mm-seed" type="number"></div>
      </div>`,
